...
class Vamtam_Customize_Responsive_Box_Fields_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'top'       => esc_html__( 'Top', 'pixelpiernyc' ),
			'right'     => esc_html__( 'Right', 'pixelpiernyc' ),
			'bottom'    => esc_html__( 'Bottom', 'pixelpiernyc' ),
			'left'      => esc_html__( 'Left', 'pixelpiernyc' ),
			'padding'   => esc_html__( 'Padding', 'pixelpiernyc' ),
		);
	}
	/**
