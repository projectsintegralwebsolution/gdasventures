...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'pixelpiernyc' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'pixelpiernyc' ),
			'font-weight'                     => esc_html__( 'Weight', 'pixelpiernyc' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'pixelpiernyc' ),
				'uppercase'    => esc_html__( 'Uppercase', 'pixelpiernyc' ),
				'lowercase'    => esc_html__( 'Lowercase', 'pixelpiernyc' ),
				'capitalize'   => esc_html__( 'Capitalize', 'pixelpiernyc' ),
				'normal'       => esc_html__( 'Normal', 'pixelpiernyc' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'pixelpiernyc' ),
				'normal'       => esc_html__( 'Normal', 'pixelpiernyc' ),
				'italic'       => esc_html__( 'Italic', 'pixelpiernyc' ),
				'oblique'      => esc_html__( 'Oblique', 'pixelpiernyc' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'pixelpiernyc' ),
				'underline'    => esc_html__( 'Underline', 'pixelpiernyc' ),
				'overline'     => esc_html__( 'Overline', 'pixelpiernyc' ),
				'line-through' => esc_html__( 'Line Through', 'pixelpiernyc' ),
				'none'         => esc_html__( 'None', 'pixelpiernyc' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'pixelpiernyc' ),
			'line-height'                => esc_html__( 'Line Height', 'pixelpiernyc' ),
			'color'                      => esc_html__( 'Font Color', 'pixelpiernyc' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'pixelpiernyc' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'pixelpiernyc' ), [ 'code' => [] ] ),
		);
	}
	/**
