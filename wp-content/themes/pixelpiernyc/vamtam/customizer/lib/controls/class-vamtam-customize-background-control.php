...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'pixelpiernyc' ),
			'change'       => esc_html__( 'Change Image', 'pixelpiernyc' ),
			'remove'       => esc_html__( 'Remove', 'pixelpiernyc' ),
			'default'      => esc_html__( 'Default', 'pixelpiernyc' ),
			'placeholder'  => esc_html__( 'No image selected', 'pixelpiernyc' ),
			'frame_title'  => esc_html__( 'Select Image', 'pixelpiernyc' ),
			'frame_button' => esc_html__( 'Choose Image', 'pixelpiernyc' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'pixelpiernyc' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'pixelpiernyc' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'pixelpiernyc' ),
				'repeat'    => esc_html__( 'Repeat both', 'pixelpiernyc' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'pixelpiernyc' ),
				'fixed'  => esc_html__( 'fixed', 'pixelpiernyc' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'pixelpiernyc' ),
				'cover'   => esc_html__( 'cover', 'pixelpiernyc' ),
				'contain' => esc_html__( 'contain', 'pixelpiernyc' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'pixelpiernyc' ),
				'left center'   => esc_html__( 'left center', 'pixelpiernyc' ),
				'left bottom'   => esc_html__( 'left bottom', 'pixelpiernyc' ),
				'center top'    => esc_html__( 'center top', 'pixelpiernyc' ),
				'center center' => esc_html__( 'center center', 'pixelpiernyc' ),
				'center bottom' => esc_html__( 'center bottom', 'pixelpiernyc' ),
				'right top'     => esc_html__( 'right top', 'pixelpiernyc' ),
				'right center'  => esc_html__( 'right center', 'pixelpiernyc' ),
				'right bottom'  => esc_html__( 'right bottom', 'pixelpiernyc' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'pixelpiernyc' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'pixelpiernyc' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'pixelpiernyc' ),
			'background-repeat'     => esc_html__( 'Repeat', 'pixelpiernyc' ),
			'background-image'      => esc_html__( 'Image', 'pixelpiernyc' ),
			'background-attachment' => esc_html__( 'Attachment', 'pixelpiernyc' ),
			'background-size'       => esc_html__( 'Size', 'pixelpiernyc' ),
			'background-position'   => esc_html__( 'Position', 'pixelpiernyc' ),
			'background-color'      => esc_html__( 'Color', 'pixelpiernyc' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'pixelpiernyc' ),
				'color-2'              => esc_html__( 'Color 2', 'pixelpiernyc' ),
				'location'             => esc_html__( 'Location', 'pixelpiernyc' ),
				'type'                 => esc_html__( 'Type', 'pixelpiernyc' ),
				'position'             => esc_html__( 'Position', 'pixelpiernyc' ),
				'angle'                => esc_html__( 'Angle', 'pixelpiernyc' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'pixelpiernyc' ),
					'radial' => esc_html__( 'Radial', 'pixelpiernyc' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'pixelpiernyc' ),
					'center left'   =>  esc_html__( 'Center Left' , 'pixelpiernyc' ),
					'center right'  =>  esc_html__( 'Center Right' , 'pixelpiernyc' ),
					'top center'    =>  esc_html__( 'Top Center' , 'pixelpiernyc' ),
					'top left'      =>  esc_html__( 'Top Left' , 'pixelpiernyc' ),
					'top right'     =>  esc_html__( 'Top Right' , 'pixelpiernyc' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'pixelpiernyc' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'pixelpiernyc' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'pixelpiernyc' ),
				],
			],
		);
