	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'pixelpiernyc' ),
				'iconName'   => esc_html__( 'Icon', 'pixelpiernyc' ),
				'iconText'   => esc_html__( 'Text', 'pixelpiernyc' ),
				'iconLink'   => esc_html__( 'Link', 'pixelpiernyc' ),
				'iconChange' => esc_html__( 'Change', 'pixelpiernyc' ),
				'fonts'      => $GLOBALS['vamtam_fonts'],
				'home_url'   => home_url(),
				'elementsTxt' => esc_html__( 'Enter your Envato Elements Token.', 'pixelpiernyc' ),
				'tfPcTxt' => esc_html__( 'Enter your purchase code from ThemeForest to receive theme updates and support.', 'pixelpiernyc' ),
				'unRegPcTxt' => esc_html__( 'You are about to unregister your purchase code. Are you sure you want to continue?', 'pixelpiernyc' ),
				'unRegTokenTxt' => esc_html__( 'You are about to unregister your Envato Elements Token. Are you sure you want to continue?', 'pixelpiernyc' ),
