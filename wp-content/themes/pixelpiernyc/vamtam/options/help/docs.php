	...
	<div id="vamtam-ts-main">
		<div class="main-content">
			<div class="vamtam-sd vamtam-box-wrap">
				<header>
					<h3><?php esc_html_e( 'Support and Documentation', 'pixelpiernyc' ); ?></h3>
				</header>
				<div class="content">
					<span><?php esc_html_e( 'Thank you for purchasing our theme! Feel free to browse our knowledgebase for videos and extra help.', 'pixelpiernyc' ); ?></span>
					<div class="cards-wrap">
						<span class="vamtam-box-btn">
							...
							<a href="https://elementor.support.vamtam.com/support/home" class="button" target="_blank">
								<?php esc_html_e( 'Knowledgebase', 'pixelpiernyc' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://elementor.support.vamtam.com/support/solutions/articles/245218-vamtam-elementor-themes-how-to-install-the-theme-via-the-admin-panel-" class="button" target="_blank">
								<?php esc_html_e( 'Installation Guide', 'pixelpiernyc' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://elementor.support.vamtam.com/support/solutions/articles/245219-vamtam-elementor-themes-how-to-update-a-vamtam-theme-and-the-bundled-plugins-" class="button" target="_blank">
								<?php esc_html_e( 'How to Update Guide', 'pixelpiernyc' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://elementor.support.vamtam.com/support/solutions/articles/245221-vamtam-elementor-themes-video-guides-for-beginners" class="button" target="_blank">
								<?php esc_html_e( 'Video Guides for Beginners', 'pixelpiernyc' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://vamtam.com/child-themes" class="button" target="_blank">
								<?php esc_html_e( 'Child Themes', 'pixelpiernyc' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://vamtam.com/changelog" class="button" target="_blank">
								<?php esc_html_e( 'Changelog', 'pixelpiernyc' ); ?>
							</a>
						</span>
					</div>
				</div>
			...
			<div class="vamtam-hd-ss-wrap">
				<div class="vamtam-hd vamtam-box-wrap">
					<header>
						<h3><?php esc_html_e( 'Have any queries outside of the scope?', 'pixelpiernyc' ); ?></h3>
					</header>
					<div class="content">
						<p class="vamtam-description"><?php esc_html_e( 'Should you have any queries outside of the scope of the help materials and the video guides don\'t hesitate to contact us.', 'pixelpiernyc' ); ?></p>
						<a href="https://themeforest.net/user/vamtam" class="vamtam-ts-button button" target="_blank">
							<?php esc_html_e( 'Contact Us', 'pixelpiernyc' ); ?>
						</a>
					</div>
				</div>
				<div class="vamtam-ss vamtam-box-wrap">
					<header>
						<h3><?php esc_html_e( 'Enable System Status Information Gathering', 'pixelpiernyc' ); ?></h3>
					</header>
					<div class="content">
						...
						<div id="vamtam-post-result">
							...
							<p style="color: green;" class="vamtam-post-msg-success"><?php echo esc_html__( 'Settings Saved Successfully', 'pixelpiernyc' ) ?></p>
							<p style="color: red;" class="vamtam-post-msg-failure"><?php echo esc_html__( 'There was a problem saving the settings to the database, please try again.', 'pixelpiernyc' ) ?></p>
						</div>
					</div>
				</div>
			</div>
